...
public class PizzaAddonsController {
    ...
    @FXML
    private Spinner pizza_quantity;
    @FXML
    private Spinner drinks_quantity;
    @FXML
    private Spinner addons_quantity;
    ...
    private void AddtoOrderClicked(MouseEvent event) {
        try {
            ...
            String completePizzaName = String.format("%s\n%s (%s)\n%s", PizzaName.getText(), selectedDrink, selectedSize, selectedAddon.equals("No Thanks") ? "" : selectedAddon);
            ...
            OrderMenuController.addOrderItem(completePizzaName, formattedPrice, foodCode, quantity);
