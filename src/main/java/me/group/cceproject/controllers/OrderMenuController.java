...
public class OrderMenuController {
    ...
    public void initialize() {
        ...
        PizzaPriceTable.setCellValueFactory(new PropertyValueFactory<>("pizzaPrice"));
    ...
    public static void addOrderItem(String pizzaName, String pizzaPrice, String foodCode, int quantity) {
        System.out.println("Adding order item: " + pizzaName + " - " + pizzaPrice + " - " + foodCode);
        if (staticOrderItems == null) {
            staticOrderItems = FXCollections.observableArrayList();
        }
        staticOrderItems.add(new OrderItem(pizzaName, pizzaPrice, foodCode, quantity));
    }
    ...
    public void B1Clicked(MouseEvent event) {
        String pizzaName = "Yumburger";
        String pizzaPrice = "₱ 99";
        String imagePath = "B1.png";
        String foodCode = "B1";

        LoadPizzaAddons(pizzaName, pizzaPrice, imagePath, foodCode, event);
    }

    // Cheesy Burger/B2
    @FXML
    public void B2Clicked(MouseEvent event) {
        String pizzaName = "Cheesy Burger";
    ...
    public void C1Clicked(MouseEvent event) {
        String pizzaName = "Spicy Chicken Wings";
    ...
    private void LoadPizzaAddons(String pizzaName, String pizzaPrice, String imagePath, String foodCode, MouseEvent event) {
        try {
